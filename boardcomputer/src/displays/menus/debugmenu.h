...
using FrontLedChangeScreen = ChangeValueDisplay<bool, AccessorHelper<FrontLedAccessor>, Tscreen, TEXT_SETFRONTLED>;

struct BackLedAccessor { static auto &getRef() { return back.command.led; } };
template<typename Tscreen>
using BackLedChangeScreen = ChangeValueDisplay<bool, AccessorHelper<BackLedAccessor>, Tscreen, TEXT_SETBACKLED>;
