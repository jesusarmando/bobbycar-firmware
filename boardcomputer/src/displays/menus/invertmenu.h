...
using FrontLeftInvertedChangeScreen = ChangeValueDisplay<bool, AccessorHelper<FrontLeftInvertedAccessor>, Tscreen, TEXT_INVERTFRONTLEFT>;

struct FrontRightInvertedAccessor { static auto &getRef() { return front.invertRight; } };
template<typename Tscreen>
using FrontRightInvertedChangeScreen = ChangeValueDisplay<bool, AccessorHelper<FrontRightInvertedAccessor>, Tscreen, TEXT_INVERTFRONTRIGHT>;

struct BackLeftInvertedAccessor { static auto &getRef() { return back.command.left.enable; } };
template<typename Tscreen>
using BackLeftInvertedChangeScreen = ChangeValueDisplay<bool, AccessorHelper<BackLeftInvertedAccessor>, Tscreen, TEXT_INVERTBACKLEFT>;

struct BackRightInvertedAccessor { static auto &getRef() { return back.invertRight; } };
template<typename Tscreen>
using BackRightInvertedChangeScreen = ChangeValueDisplay<bool, AccessorHelper<BackRightInvertedAccessor>, Tscreen, TEXT_INVERTBACKRIGHT>;
