...
constexpr auto defaultDefaultModeAddSchwelle = 950, defaultDefaultModeGas1Wert = 1250, defaultDefaultModeGas2Wert = 1250, defaultDefaultModeBrems1Wert = 250, defaultDefaultModeBrems2Wert = 750;
}
